...
!---------------------------------------------------------------------
 ...
 200            format(' Time step ', i4)
          ...
          if (node .eq. root) then
              ...
              call dmtcpf_checkpoint(C_CHAR_""//C_NULL_CHAR)
 ...
 1100        format(/' BTIO -- statistics:'/  &
     ...
     &               '   I/O data rate  (MB/sec) : ', f14.2)
             ...
             write(*,1110) timer_read(t_checkpoint), timer_read(t_compute)
 1110        format(/' DMTCP -- statistics:'/  &
     &               '   Checkpoint timing in seconds   : ', f14.2/  &
     &               '   Compute timing in seconds   : ', f14.2)
